...
save(FDP_result, FDX_result, power_result, file = paste0("table2_a0.5_theta",theta))


load(file = paste0("table2_a0.5_theta",theta))
...
write.csv(results, file = paste0("table2_a0.5_theta",theta, ".csv"))
