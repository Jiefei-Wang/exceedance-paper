...
save(FDP_result, FDX_result, power_result, file = paste0("figure1_m",hypo_num,"_theta",theta))

load(file = paste0("figure1_m",hypo_num,"_theta",theta))
...
png(file=paste0("figure1_m",hypo_num,"_theta",theta, ".png"),width=600, height=500)
