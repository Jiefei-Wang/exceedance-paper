...
save(FDP_result, FDX_result, power_result, file = paste0("figure3_m",hypo_num,"_theta",theta, "_cor", cor))

load(file = paste0("figure3_m",hypo_num,"_theta",theta, "_cor", cor))
...
png(file=paste0("figure3_m",hypo_num,"_theta", "_cor", cor, ".png"),width=600, height=500)
